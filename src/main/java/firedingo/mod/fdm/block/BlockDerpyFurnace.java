...
public class BlockDerpyFurnace extends BlockContainer implements ITileEntityProvider {
    ...
    public BlockDerpyFurnace(boolean isBurning, String unlocalizeName, String registryName) {
        super(Material.ROCK);
        setUnlocalizedName(unlocalizeName);
    ...
    {
        return Item.getItemFromBlock(ModBlocks.DerpyFurnace);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            {
            	FMLNetworkHandler.openGui(playerIn, FiresDerpyMod.instance, 2, worldIn, pos.getX(), pos.getY(), pos.getZ());
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, ModBlocks.Lit_DerpyFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.Lit_DerpyFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, ModBlocks.DerpyFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.DerpyFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityDerpyFurnace)
            {
                ((TileEntityDerpyFurnace)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        if (!keepInventory)
        {
            ...
            if (tileentity instanceof TileEntityDerpyFurnace)
            {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityDerpyFurnace)tileentity);
    ...
    //END OF COMPARATOR STUF
    
    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ModBlocks.DerpyFurnace);
    }
